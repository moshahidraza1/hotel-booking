    ...
    <section id={'rooms'} className='w-full py-24 px-6 md:px-20 bg-[#FDFCF8]'>
        ...
        <div className='flex flex-col justify-between mt-12 '>
            <div>
                ...
                <button className='hidden md:flex items-center gap-2 text-black border-b border-black pb-1 hover:text-amber-600 hover:border-amber-600 transition-all'><Link href='/cabins'>View All Cabins</Link> <ArrowUpRight size={18}/></button>
            </div>
            ...
            <button className='md:hidden mt-10 w-full flex items-center justify-center gap-2 text-black border border-black py-3 rounded-full hover:bg-black hover:text-white transition-all'><Link href='/cabins'> View All Cabins</Link> <ArrowUpRight size={18}/></button>
        </div>
    </section>
  )
}
